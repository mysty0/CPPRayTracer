...
ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, std::weak_ptr<ObjectTexture> texture) :
		vertices({{v0, v1, v2}}), texturePoints(), texture(texture), normal(), vertexNormals() {}

ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, const glm::vec2 &v0t, const glm::vec2 &v1t, const glm::vec2 &v2t, std::weak_ptr<ObjectTexture> texture) :
...
std::ostream &operator<<(std::ostream &os, const ModelTriangle &triangle) {
	...
	auto tex = triangle.texture.lock();
	if(tex)
